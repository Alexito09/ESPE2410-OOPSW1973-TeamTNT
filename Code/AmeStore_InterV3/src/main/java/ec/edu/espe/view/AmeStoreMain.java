 ...
 * @author USUARIO
 */
public class AmeStoreMain extends javax.swing.JFrame {

    /**
     * Creates new form AmeStoreMain
     */
    public AmeStoreMain() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(193, 37, 142));
        ...
        jLabel6.setText("Stock Diponible");
        ...
        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 600, 380));

        jPanel9.setBackground(new java.awt.Color(242, 65, 176));
        jPanel9.setForeground(new java.awt.Color(204, 75, 193));

        jLabel1.setBackground(new java.awt.Color(140, 36, 142));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AmeStoreMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AmeStoreMain().setVisible(true);
            }
        });
    }
