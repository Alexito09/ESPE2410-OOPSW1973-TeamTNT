 ...
 *
 */
public final class FrmMenuAmeStore extends javax.swing.JFrame {

    int xMouse, yMouse;
    
    public FrmMenuAmeStore() {
        initComponents();
        hideStartBtnsMenu();
    ...
    private void initComponents() {
        ...
        bgPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 150, 530, 90));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMenuAmeStore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMenuAmeStore().setVisible(true);
            }
        });
    }
