...
public class FrmAmeStoreSplash extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        title1.setText("Sistema de Tienda de Ropa");

        title2.setFont(new java.awt.Font("Roboto Black", 1, 36)); // NOI18N
        title2.setText("AME STORE APP");

        jLabel1.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jLabel1.setText("@TNT Developer Team");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAmeStoreSplash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAmeStoreSplash().setVisible(true);
            }
        });
    }
